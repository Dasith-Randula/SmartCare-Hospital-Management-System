...
public class BillRequest {
    ...
    public void setLaboratoryCharge(BigDecimal laboratoryCharge) { this.laboratoryCharge = laboratoryCharge; }
    public BigDecimal getMedicineCharge() { return medicineCharge; }
    public void setMedicineCharge(BigDecimal medicineCharge) { this.medicineCharge = medicineCharge; }
